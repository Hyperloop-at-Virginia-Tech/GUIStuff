...
QT_MOC_LITERAL(4, 40, 9), // "setNumber"
QT_MOC_LITERAL(5, 50, 6), // "number"
QT_MOC_LITERAL(6, 57, 5) // "start"

    },
    "SendData\0numberChanged\0\0QVector<double>\0"
    "setNumber\0number\0start"
};
...
void SendData::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->numberChanged((*reinterpret_cast< QVector<double>(*)>(_a[1]))); break;
        case 1: _t->setNumber((*reinterpret_cast< QVector<double>(*)>(_a[1]))); break;
        ...
        {
            using _t = void (SendData::*)(QVector<double> );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SendData::numberChanged)) {
                *result = 0;
                return;
            }
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< QVector<double>*>(_v) = _t->number(); break;
        default: break;
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: _t->setNumber(*reinterpret_cast< QVector<double>*>(_v)); break;
        default: break;
        }
...
QT_INIT_METAOBJECT const QMetaObject SendData::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_SendData.data,
    qt_meta_data_SendData,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void SendData::numberChanged(QVector<double> _t1)
{
